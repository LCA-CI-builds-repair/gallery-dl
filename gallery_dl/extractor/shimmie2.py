...
class Shimmie2TagExtractor(Shimmie2Extractor):
    ...
    test = (
        ...
        ("https://rule34hentai.net/post/list/comic/1", {
            "pattern": r"https://rule34hentai\.net/_images/[0-9a-f]{32}/\d+",
            "range": "1-100",
            "count": 100,
        }),
    ...
    def posts(self):
        ...
        while True:
            ...
            while True:
                ...
                tags, dimensions, size, ext = extr("title=\"", "\"").split(" // ")
...
class Shimmie2PostExtractor(Shimmie2Extractor):
    ...
    test = (
        ...
        ("https://rule34hentai.net/post/view/10", {
            "pattern": r"https://rule34hentai\.net/\./index\.php"
                       r"\?q=/image/10\.jpg",
            "content": "d0fd8f0f6517a76cb5e23ba09f3844950bf2c516",
            "keyword": {
                "extension": "jpg",
                "file_url": "https://rule34hentai.net/./index.php"
                            "?q=/image/10.jpg",
                "filename": "10",
                "height": 427,
                "id": 10,
        ...
        # video
        ("https://rule34hentai.net/post/view/91267", {
            "pattern": r"https://rule34hentai\.net/\./index\.php"
                       r"\?q=/image/91267\.mp4",
        }),
