...
sys.path.insert(0, os.path.dirname(os.path.dirnametests = [t for t in tests if t.get("#category") and t["#category"][-1] == subcategory]
else:
    tests = results.all()

# add 'test_...' methodsath.abspath(__file__))))
